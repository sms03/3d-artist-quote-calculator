...
const Navbar = () => {
  ...
  const navItems = [
    { name: "Home", path: "/" },
    { name: "3D Still Frame", path: "/3d-still-frame" },
    { name: "3D Animations", path: "/3d-animations" },
    { name: "3D CGI", path: "/3d-cgi" },
    { name: "VFX Projects", path: "/vfx-projects" },
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-design-purple hover:bg-gray-100"
            >
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.path}
                className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-design-purple hover:bg-gray-100"
